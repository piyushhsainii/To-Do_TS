    ...
    <div className=' bg-gray-900 min-w-[100vw] min-h-[100vh]  w-[100%] h-[100%] ' >
        ...
        {/* Form starts from here */}
                <div className="w-[40vw] h-[55vh] border-yellow-300 border m-auto mt-12 ">
                    <div className="font-Bungee-Spice text-center text-2xl m-4"> SIGN UP ON MYFUNDS </div>
                    <form action="">
                       <div className="flex flex-col gap-6 font-Bungee-Spice" >
                            ...
                            <button className="border-yellow-300 border border-opacity-10 py-2 m-auto w-[70%]" type="submit">SIGN UP  </button>
                            <Link className=" text-center text-[10px] " to='/Login'><button className=" text-white underline"> already a user? Click here to Login   </button></Link>
                       </div>
                    </form>
                </div>
    </div>
